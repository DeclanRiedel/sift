...
impl CommandId {
    pub const fn as_str(self) -> &'static str {
        match self {
            ...
            Self::ToggleConnectionsDock => "workspace.toggle-left-dock",
            Self::ToggleInspectorDock => "workspace.toggle-right-dock",
            Self::ToggleOutputDock => "workspace.toggle-bottom-dock",
...
const DEFINITIONS: &[CommandDefinition] = &[
    ...
    command(
        CommandId::ToggleConnectionsDock,
        "Toggle Connections Dock",
        "Ctrl+Shift+B",
        true,
        AvailabilityRule::Always,
    ),
