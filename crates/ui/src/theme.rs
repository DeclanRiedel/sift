    ...
    fn dark_base() -> Self {
        Self {
            ...
            colors: ThemeColors {
                ...
                staged: hsla(0.56, 0.92, 0.72, 1.0),
                staged_muted: hsla(0.56, 0.92, 0.72, 0.16),
    ...
    fn light_base() -> Self {
        Self {
            ...
            colors: ThemeColors {
                ...
                staged: hsla(0.56, 0.54, 0.43, 1.0),
                staged_muted: hsla(0.56, 0.54, 0.43, 0.14),
